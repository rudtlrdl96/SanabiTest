...
Properties {
_TessEdge ("Tess Edge", Float) = 1
_ColorNoiseSpeed ("Noise Speed", Float) = 0
_DeformationNoiseSpeed ("Deformation Noise Speed", Float) = 0
_CellDivision ("Cell Division", Float) = 0
_DeformationStrength ("Deformation Strength", Float) = 0
...
_ScanLineJitter ("Scan Line", Vector) = (0,0,0,0)
